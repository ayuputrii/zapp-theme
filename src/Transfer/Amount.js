        ...
        <div className="row">
            ...
            <div className="col-xs-12 col-sm-12 col-md-7 col-lg-8 d-AllSearch">
              <form>
                  ...
                  <div className="container">
                      <input type="text text1" name="amount" id="amount" onChange={this.handlerChange} placeholder="0.00" />
                  </div>
                  ...
                  <div className="container">
                      <input type="text" id="note" name="notes" onChange={this.handlerChange} placeholder="Add some notes" />
                  </div>
                  <div className="container py-4">
                      <button type="submit" className="nav justify-content-center bg-link ml-auto mt-5" id="continue">Continue</button>
                  </div>
              </form>
            </div>
        </div>
